...
export default async function MenuList(): Promise<JSX.Element> {
  return (
    <>
      <section className="max-w-[1440px] mx-auto relative h-screen grid grid-cols-2">
        ...
        >
          {/* <div className="absolute top-8 mx-auto w-1/2 flex justify-center items-center z-50">
        ...
        {/* Right Side */}
        <div className="h-screen pt-[900px] pb-60 flex flex-col gap-20 items-center justify-center px-20 text-center overflow-y-scroll">
